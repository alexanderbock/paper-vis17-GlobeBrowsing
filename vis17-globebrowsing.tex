...
Image data are collected by instruments on satellites and spacecraft, and used in scientific research and mission planning.

While mapping data from space missions is often shared openly, it can be difficult for non-experts to comprehend the context of the data and understand the acquisition process.
We present an application where scientific mapping data of celestial bodies is shown in a visualization suitable for public disemmination.

By combining various data sets and visualization techniques, we are able to contextualize mapping data spatially and temporally. 
A chunked level of detail approach is used to enable interactive exploration of global maps with color and height information.
...
%The mapping of the planet and moons within our solar system is carried out by space organizations such as NASA and ESA.
