...
\shortauthortitle{Bladin \MakeLowercase{\textit{et al.}}: Globe Browsing: Contextualized Spatio-Temporal Planetary Surface Visualization}
...
We present an application where scientific mapping data of celestial bodies is contextualized in space and time to enrich the experience in public disemmination as well as support communication between scientists.
Various types of datasets and visualization techniques are combined. 
...
Furthermore, we interactively playback in-situ visualizations of the data acquisition process.
