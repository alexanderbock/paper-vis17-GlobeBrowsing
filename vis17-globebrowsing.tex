...
%% Abstract section.
\abstract{%
We present work on tailoring and integration of multiple data processing and visualization methods to accurately and interactively contextualize geospatial data of celestial bodies for use in public science dissemination and communication between domain scientists.
% The primary target use is in science communication, but also  is one of the use scenarios.
Results of mapping of the planets and moons in our solar system is often shared data openly for use in scientific research and mission planning.
However, this data is, in its raw format, not accessible to non-experts, as it is difficult to grasp the context of the data and the intricate acquisition process from satellites and spacecraft.
...
We describe the image acquisition, required pre-processing steps to derive a 2.5D terrain, and a chunked level-of-detail rendering approach to enable the interactive exploration of global maps as well as high-resolution digital terrain models.
...
In addition to visualizing the scientific results, we also provide the ability to show the ongoing data acquisition process, exemplified in the Pluto flyby of the New Horizons spacecraft.
