...
A second case is showing dynamic processes, such as high-resolution, concurrent weather conditions on Earth that require temporal datasets.
...
\teaser{
  \centering
  \includegraphics[width=\linewidth, height=0.35\linewidth]{figures/teaser2.jpg}
...
\begin{figure}[b!]
  ...
  \caption{Loading times for different data sources illustrated by the number of rendered chunks. Each recording is performed by enabling the layer when the camera is 50\,m from the ground facing the horizon.}  %\vspace*{-4mm}
...
\acknowledgments{
We would like to acknowledge the Swedish e-Science Research Center (SeRC) for their support of this work.
Parts of this work were supported by NASA under award No NNX16AB93A, the Moore-Sloan Data Science Environment at New York University, NSF awards CNS-1229185, CCF-1533564, and CNS-1544753.
The authors would like to thank Ryan Boller, Lucian Plesea, and the NASA GIBS team for their help.
}
