...
We describe the image acquisition, required pre-processing steps to derive a 2.5D terrain model, and a chunked level-of-detail rendering approach to enable interactive exploration of global maps as well as local high-resolution digital terrain models.
...
Our work has been implemented in the open source software OpenSpace that enables interactive presentations in a range of environments such as, immersive dome theaters and virtual reality headsets.
