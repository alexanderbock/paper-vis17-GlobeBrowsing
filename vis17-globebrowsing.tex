...
\shortauthortitle{Bladin \MakeLowercase{\textit{et al.}}: Marsbrowsing}
...
We can use the same data that scientists use in their research for public dissemination and present it, bundled and contextualized, using immersive rendering systems. Our software, OpenSpace, is an open source software with the goal of bringing space science to the general public.

\kallecomment{Please bash my text and make it better :). Are we focusing on the right things for the abstract?}
